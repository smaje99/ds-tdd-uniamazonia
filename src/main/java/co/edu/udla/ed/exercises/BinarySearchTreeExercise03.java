...
/**
 * Exercise 03 for the Binary Search Tree series.
 *
 * <p><strong>Student task:</strong> Remove a non-root value and report both the removal result and the updated in-order traversal.</p>
 *
