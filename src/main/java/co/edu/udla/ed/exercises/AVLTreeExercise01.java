...
/**
 * Exercise 01 for the AVL Tree series.
 *
 * <p><strong>Student task:</strong> Trigger a simple AVL rotation and report the balanced height together with the in-order traversal.</p>
 *
