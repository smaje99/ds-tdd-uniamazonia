...
/**
 * Doubly-list implementation that emphasizes explicit iterative access.
 *
 * <p>
 * The underlying {@link LinkedList} already stores links in both directions,
 * but lookup-style operations are still written in an explicitly iterative way
 * so the linear traversal cost remains visible to students.
 * </p>
 *
 * @param <T> the element type
 */
public class LinearDoublyLinkedList<T> implements DoublyList<T> {
