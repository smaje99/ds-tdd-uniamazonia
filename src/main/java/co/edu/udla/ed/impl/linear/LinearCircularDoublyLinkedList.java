...
/**
 * Circular doubly linked-list implementation using explicit iterative access.
 *
 * <p>
 * The wrapper preserves the circular-list contract while making the cost of
 * indexed access and membership checks explicit through iterative scans.
 * </p>
 *
 * @param <T> the element type
 */
public class LinearCircularDoublyLinkedList<T> implements CircularList<T> {
